...
#import "UIButton+customeBtn.h"
@implementation UIButton (customeBtn)
     ...
     //NSLog(@"按钮图片 width: %f  height: %f \n", imageWidth, imageHeight);
      //NSLog(@"按钮文字 width: %f  height: %f \n", labelWidth, labelHeight);
       // NSLog(@"按钮大小 width: %f  height: %f \n", self.frame.size.width, self.frame.size.height);
        ...
        switch (position) {
            case JCButtonImagePositionLeft:
                //    图片在左、文字在右;
                imageTop = 0;
                imageBottom = 0;
                imageLeft =  -space / 2.0;
            ...
            case JCButtonImagePositionTop://    图片在上，文字在下
            ...
            case JCButtonImagePositionRight:// 图片在右，文字在左
                imageTop = 0;
                imageBottom = 0;
            ...
            case JCButtonImagePositionBottom://    图片在下，文字在上
